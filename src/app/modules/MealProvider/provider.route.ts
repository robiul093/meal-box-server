...
router.get('/providers/orders',
  auth('provider'),
  providerController.getOrder
);

router.get('/providers/popular-meal',
  auth('provider'),
  providerController.getMostOrderedMeal
);
